                                            ...
                                            <div className="space-y-3">
                                                {projects.map((project, i) => {
                                                    const typeLabels: Record<string, { label: string; color: string; icon: string }> = {
                                                        ...
                                                        'docker-app-evolution': { label: 'Evolution API', color: 'from-green-500 to-emerald-500', icon: '💬' },
                                                        'docker-app-evolution-go': { label: 'Evolution Go', color: 'from-emerald-500 to-cyan-500', icon: '🚀' },
